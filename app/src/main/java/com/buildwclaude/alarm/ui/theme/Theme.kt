package com.buildwclaude.alarm.ui.theme
...
/**
 * App-wide Material 3 theme for the ordinary "chrome" of the app (list, settings, etc.).
 * The time-of-day picker screen paints its own colours on top of this.
 *
 * On One UI (Android 12+), [dynamicColor] adopts the user's wallpaper palette.
 */
@Composable
fun RiddleAlarmTheme(
